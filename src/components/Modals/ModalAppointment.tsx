  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger asChild>
          ...
          <Image src={TerminButton} alt="Termin Button" width={200} height={200} className="z-50 absolute w-36 top-[80vh] right-1  cursor-pointer absolute top-[84vh] md:w-36 md:top-[15vh] md:right-12 lg:w-54" />
