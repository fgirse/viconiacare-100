...
export default function WhyUsSection() {
  ...
  return (
    <section id="why-us" className="py-[120px] px-6 bg-stone-50 scroll-mt-[72px]">
      <div className="max-w-[100vw] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div className="reveal-why opacity-0 translate-y-7 transition-all duration-700 relative lg:block">
          ...
          {/* Stat card 1 */}
          <div className="absolute -bottom-6 -left-8 bg-white rounded-2xl px-5 py-4 shadow-xl flex items-center gap-3">
            <div className="w-11 h-11 rounded-xl bg-teal-100 flex items-center justify-center text-xl">🏅</div>
            <div>
              <div className="font-display text-[1.4rem] font-black text-teal-900 leading-none">MDK</div>
              <div className="text-[0.75rem] font-bold uppercase tracking-wider text-stone-500 mt-0.5">Sehr gut</div>
            </div>
          </div>

          {/* Stat card 2 */}
          <div className="absolute top-10 -right-8 bg-white rounded-2xl px-5 py-4 shadow-xl flex items-center gap-3">
            <div className="w-11 h-11 rounded-xl bg-orange-100 flex items-center justify-center text-xl">⚡</div>
            <div>
              <div className="font-display text-[1.4rem] font-black text-teal-900 leading-none">48h</div>
              <div className="text-[0.75rem] font-bold uppercase tracking-wider text-stone-500 mt-0.5">Pflegebeginn</div>
            </div>
          </div>
        </div>
